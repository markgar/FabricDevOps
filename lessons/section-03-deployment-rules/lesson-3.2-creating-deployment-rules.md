...
> 💡 **Remember:** If you have changes to deploy, tag them first! Create a tag like `prod-2024-12-22` before deploying (see [Lesson 2.2](../section-02-deployment-pipelines/lesson-2.2-tagging-releases.md)).
