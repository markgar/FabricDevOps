...
If you decide you need a Test environment, the process is straightforward:

1. Create a new workspace (e.g., `FabricDevOps-Workshop-Test`)
2. In your deployment pipeline, add a stage between Dev and Prod
3. Assign the Test workspace to that stage
4. Deploy: Dev → Test → Prod

The mechanics are the same as what you've already learned—just with an extra step.
