...
You already used the variables in code in the previous section.

> ✅ You should see output that includes `RunLabel`, and a table should appear in your lakehouse.
